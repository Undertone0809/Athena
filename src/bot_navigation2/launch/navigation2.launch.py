...
def generate_launch_description():
    ...
    map_yaml_path = LaunchConfiguration('map',default=os.path.join(bot_navigation2_dir,'maps','bot_map.yaml'))
    nav2_param_path = LaunchConfiguration('params_file',default=os.path.join(bot_navigation2_dir,'param','bot.yaml'))
